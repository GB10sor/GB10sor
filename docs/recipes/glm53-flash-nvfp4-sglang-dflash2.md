# LibertAIDAI GLM-5.3 Flash NVFP4 with DFlash2 (SGLang Deuces)

| Field | Value |
| --- | --- |
| Profile | `glm53-flash-nvfp4-sglang-dflash2` |
...
| Qualification status | `qualified-deuces-gb10-direct-fresh-owner-v45` |
| Upstream | https://huggingface.co/LibertAIDAI/GLM-5.3-Flash-NVFP4 |

```bash
nix develop path:.#model-glm53-flash-nvfp4-sglang-dflash2 --command ./scripts/launch-model.sh qualify-and-serve
```
