# NVIDIA Nemotron 3 Ultra 550B A55B NVFP4 (Eights TP4 x PP2, bounded 16K candidate)

| Field | Value |
| --- | --- |
| Profile | `nemotron-ultra-eights-vllm022` |
...
| Qualification status | `qualified-eights-gb10-switched-vllm022-tp4-pp2-bounded16k-functional-v1` |
| Upstream | https://huggingface.co/nvidia/NVIDIA-Nemotron-3-Ultra-550B-A55B-NVFP4 |

```bash
nix develop path:.#model-nemotron-ultra-eights-vllm022 --command ./scripts/launch-model.sh qualify-and-serve
```
